...
urlpatterns = [
    ...
    path('question_detail/<str:id>', question_detail, name="question_detail"),
    ...
    path('answer_edit/<int:id>', answer_edit, name="answer_edit"),
    path('answer_delete/<int:id>', answer_delete, name="answer_delete"),
    ...
    path('comment_edit_question/<int:id>', comment_edit_question, name="comment_edit_question"),
    path('comment_edit_answer/<int:id>', comment_edit_answer, name="comment_edit_answer"),
